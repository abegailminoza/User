    ...
    <form runat="server" id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow">
                                    ...
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                                        <a class="dropdown-item" hhref="USER_PROFILE.aspx"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile</a><a class="dropdown-item" href="recentblog.html"><i class="fas fa-pen fa-sm fa-fw me-2 text-gray-400"></i>Manage blog post</a>
                ...
                <asp:Button runat="server" ID="RequestBloodBtn" OnClick="RequestBloodBtn_Click" Class="btn btn-primary" UseSubmitBehavior="false" AutoPostBack="true" ValidationGroup="none" type="button" Style="background: rgb(119,40,32); height: 46px; width: 148.406px; margin: 37px; padding: 12px 12px;" Text="Request a Blood" />
                <div class="container-fluid">
